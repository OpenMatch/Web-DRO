...
def get_idx(obj):
    # Wrong id 'id' is not digital

    if 'id' in obj and '__index_level_0__' in obj:
        url = obj['text']
        try:
            obj['text'] = obj['title']
        except:
            ...
            exit(0)
        obj['title'] = obj['id']
        obj['id'] = obj['__index_level_0__']
        obj['url'] = url
        del obj['__index_level_0__']
    ...
    # with open("/home/peixuanh/OpenMatch/k8.txt", "a") as f:
    #     f.write(example_id + '\n')
    return example_id
