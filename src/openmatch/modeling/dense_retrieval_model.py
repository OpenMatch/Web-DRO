...
class DROutput(ModelOutput):
    ...
    p_reps: Tensor = None
    loss: Tensor = None
    loss_detail: Tensor = None
    scores: Tensor = None
    cluster_id: Tensor = None
    ...
    def __init__(
        ...
        if train_args is not None: 
            if train_args.distillation:
                ...
                self.loss_fn = nn.CrossEntropyLoss(reduction='none') #Modified by HPX
    ...
    def forward(
        ...
        if self.train_args.distillation:
            ...
            if self.train_args.negatives_x_device:
                ...
                cluster_id = self.dist_gather_tensor(cluster_id)
